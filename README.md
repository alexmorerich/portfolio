...
> **Manual / 使用手册:** [`MANUAL.md`](MANUAL.md) — fee mechanics, decision framework, institution profiles / 费用机制、决策框架、机构画像.
> **Last updated / 更新:** 2026-06-18 · all fees verified against each bank's & broker's **latest official schedule** (see [Sources](#sources--数据来源)).
...
| **J** | **13 institutions** (7 banks + 6 brokers), single ETF 02800, HK$10k/mo DCA over 100 mo / 13家(7行+6券商)·单只ETF月供超小额 | Yr1 **Snowball 尊嘉** (~HK$110; banks: **Wing Lung / DBS**) · hold **all 6 brokers** (~HK$60) < SC/ICBC-Wealth (~145) | **Extreme of I**: HK$10k/trade × 100 → fixed per-order cost rules → **near-zero-commission brokers crush banks** (尊嘉 HK$1/order vs HK$100-min banks = 1% effective); 100-buy commission alone = HK$100 (尊嘉) … HK$10,000 (HK$100-min banks); **BOCHK worst** |
...
![First-year total cost](charts/scenarioH_year1.png)
...
![Year 2+ annual cost](charts/scenarioH_year2.png)
...
![First-year total cost](charts/scenarioI_year1.png)
...
![Steady-state hold from Year 6](charts/scenarioI_year6.png)
...
### Scenario J — 13 institutions (7 banks + 6 brokers): HK$1M into 02800, 100-month DCA (HK$10k × 100)

**HK$10,000/month into a single ETF — 02800** (Tracker Fund of Hong Kong / 盈富基金, Hang Seng Index, **semi-annual** distribution, ~2.9% yield) for **100 months** → HK$10,000 × 100 = **exactly HK$1,000,000**. ETF → no stamp duty. This scenario uses a **different, broker-heavy line-up** — the **7 banks + 6 brokers** below (not the 11-banks-+-Futu set of Scenarios G–I). Bank rates from the Scenario G schedule; broker rates verified June 2026 (see [Sources](#sources--数据来源)).

> **This is Scenario I taken to the extreme.** I's HK$16.7k trades already let commission *minimums* bind; here each trade is just **HK$10,000 and there are 100 of them**, so the **fixed per-order cost (platform fee / commission minimum) is almost the entire bill** — and the **zero-fee brokers win by a landslide**. A HK$100 bank minimum on a HK$10k trade = **1.0% effective**; Snowball's HK$1 platform fee = **0.01%**. A 100× spread, paid 100 times.

> **HK$10k < one board lot of 02800** (500 units × ~HK$25 ≈ HK$12,500). Execute via a **Monthly Stock Investment Plan / 月供股票计划** (pools odd/fractional lots) or the odd-lot market — which also means **monthly-plan $0-commission promos apply directly** (BOCHK, HSBC, and the brokers' standing offers).

**Broker fee schedule (HK stocks, online, June 2026 — all $0 custody, no stamp duty on ETF):**

| Broker | Commission | Platform / order | Dividend collection |
|---|---|---|---|
| **尊嘉 Snowball** | **$0** (lifetime) | **HK$1** | **0.2%, min HK$30** + reg. HK$1.5/lot, min HK$31.9 |
| uSMART 盈立 | $0 (免佣 plan) | HK$12 | ~0.2%, min HK$30 |
| Longbridge 长桥 | $0 (lifetime) | HK$15 *(tiered to HK$3)* | ~0.2%, min HK$30 |
| Futu 富途 | $0 forever *(promo)* · base 0.03%/min HK$3 | HK$15 | 0.2%, min HK$30 |
| 华盛 Valuable Capital | 0.03%, min HK$3 | HK$15 | ~0.2%, min HK$30 |
| Tiger 老虎 | 0.029% *(incl. clearing)* | HK$15 *(fixed plan; tiered = HK$30 at ≤5 orders/mo)* | 0.2%, min HK$30 |

*(Brokers run standing $0-commission promos, so the platform fee is the real per-order cost; custody is $0 everywhere. Verify current promos before acting.)*

**Per-trade cost at HK$10,000** (*bold = a fat minimum binds → effective rate ≫ headline*):

| Institution | Rate gives | Min / Platform | Charged/trade | Effective |
|---|---|---|---|---|
| **尊嘉 Snowball** | $0 | HK$1 platform | **HK$1** | 0.01% |
| uSMART 盈立 | $0 | HK$12 platform | HK$12 | 0.12% |
| Longbridge 长桥 | $0 | HK$15 platform | HK$15 | 0.15% |
| Futu 富途 / 华盛 Valuable | HK$3 (0.03%) | HK$3 min + HK$15 | HK$18 | 0.18% |
| Tiger 老虎 | HK$3 (0.029%) | HK$15 platform | HK$18 | 0.18% |
| Wing Lung 永隆 | HK$18 (0.18%) | min HK$4.88 | HK$18 *(rate)* | 0.18% |
| DBS 星展 | HK$20 (0.20%) | none | HK$20 *(rate)* | 0.20% |
| SC 渣打 | HK$20 (0.20%) | min HK$50 | **HK$50** | 0.50% |
| ICBC 工银 | HK$14 (0.138%) | min HK$88 | **HK$88** | 0.88% |
| HSBC / CNCBI / BOCHK | HK$25 (0.25%) | min HK$100 | **HK$100** | 1.00% |

**First-year total cost** (first 12 buys + custody + 2 small dividends + ~HK$35 gov/exchange levies):

![First-year total cost](charts/scenarioJ_year1.png)

| # | Institution | Commission ×12 | Custody Yr1 | Div (2×) | **Year-1** |
|---|---|---|---|---|---|
| 1 | **尊嘉 Snowball** | HK$12 *(HK$1/order)* | $0 | HK$60 | **~HK$110** |
| 2 | **uSMART 盈立** | HK$144 *(HK$12/order)* | $0 | HK$60 | **~HK$240** |
| 3 | Longbridge 长桥 | HK$180 *(HK$15/order)* | $0 | HK$60 | **~HK$275** |
| 4 | Futu 富途 / 华盛 Valuable / Tiger 老虎 | HK$216 *(HK$18/order)* | $0 | HK$60 | **~HK$310** |
| 7 | Wing Lung 永隆 | HK$216 *(0.18%, no min binds)* | HK$120 | HK$60 | **~HK$430** |
| 8 | DBS 星展 | HK$240 *(0.20%, no min)* | HK$200 | HK$60 | **~HK$535** |
| 9 | SC 渣打 | HK$600 *(min HK$50)* | $0 | HK$60 | **~HK$695** |
| 10 | ICBC 工银 | HK$1,056 *(min HK$88)* | ~HK$200 | HK$40 | **~HK$1,330** |
| 11 | CNCBI 中信国际 | HK$1,200 *(min HK$100)* | HK$200 | HK$60 | **~HK$1,495** |
| 12 | HSBC 汇丰 | HK$1,200 *(min HK$100)* | HK$300 | HK$60 | **~HK$1,595** |
| 13 | BOCHK 中银香港 | HK$1,200 *(min HK$100)* | HK$2,000 | HK$150 | **~HK$3,385** |

**Steady-state hold from Year 9** (fully invested HK$1M, **buying done** — custody + dividend only). 02800's **2 large semi-annual dividends** (~HK$14.5k each → 0.5% ≈ HK$72/payout) beat every minimum, so the dividend fee ≈ HK$145/yr at the **banks**; brokers' lower/waived dividend fees + **$0 custody** put them at the floor:

![Steady-state hold from Year 9](charts/scenarioJ_steady.png)

| # | Institution | Year-9+ /yr |
|---|---|---|
| 1 | **All 6 brokers** — 尊嘉 Snowball / uSMART 盈立 / Longbridge 长桥 / Futu 富途 / 华盛 Valuable / Tiger 老虎 | ~HK$60 *(custody $0; dividend 0.2% min HK$30 × 2 payouts)* |
| 7 | SC 渣打 / ICBC-Wealth 工银理财金 | ~HK$145 *(custody $0; dividend 0.5% ≈ HK$145)* |
| 9 | Wing Lung 永隆 | ~HK$265 |
| 10 | CNCBI 中信国际 | ~HK$345 |
| 11 | DBS 星展 | ~HK$395 |
| 12 | HSBC 汇丰 | ~HK$445 |
| 13 | BOCHK 中银香港 | ~HK$2,150 |

> **Registration-fee caveat (verify before relying on the hold-cost ranking).** 尊嘉 Snowball additionally levies a **登记过户费 (registration fee) of HK$1.5/lot, min HK$31.9, *per dividend*** (confirmed by 尊嘉 customer service, June 2026). On a fully-built HK$1M position (~80 lots of 02800) that's ~HK$120/payout (~HK$240/yr) *on top of* the 0.2% service fee — which would lift its steady-state to **~HK$300**. Comparable registrar pass-through fees may apply at other brokers and banks; the table above counts **only the 0.2%/min HK$30 dividend service fee**, so confirm each institution's registrar/过户 fee for large holdings.

**Findings:**
- **Year 1 → Snowball 尊嘉 (~HK$110), and every broker beats every bank.** The six brokers land at **HK$110–310**; the seven banks at **HK$430–3,385**. With trades this small the per-order *fixed* cost is the whole game: 尊嘉's HK$1 platform → HK$12/yr commission vs the HK$100-min banks' HK$1,200/yr.
- **Among banks, Wing Lung and DBS win** (~HK$430 / ~HK$535) — the only two whose commission is pure rate (0.18% / 0.20%, no fat minimum). The **HK$100-minimum banks are worst** (HSBC / CNCBI / BOCHK ~HK$1,495–3,385): a HK$100 min on HK$10k = **1% effective**, ~5× Wing Lung's true 0.18%.
- **ICBC is mid-pack again** (~HK$1,330): its HK$88 minimum — the weapon that won the *big-trade* Scenario H — is dead weight on HK$10k trades, plus ~HK$200 custody (sub-Wealth during the build).
- **The real number is the 100-month build, not Year 1.** Commission repeats every month for **8⅓ years**. **Cumulative commission across all 100 buys: 尊嘉 HK$100 · uSMART HK$1,200 · 长桥 HK$1,500 · Futu/华盛/Tiger/Wing Lung HK$1,800 · DBS HK$2,000 · SC HK$5,000 · ICBC HK$8,800 · HSBC/CNCBI/BOCHK HK$10,000.** Choosing Snowball over a HK$100-min bank saves **~HK$9,900** over the accumulation — for the *identical* ETF.
- **Steady-state (Year 9+) → all six brokers tie at the floor (~HK$60), ahead of even the $0-custody banks.** Every broker charges **$0 custody** *and* the same dividend service fee (0.2% min HK$30 → ~HK$60/yr) — incl. 尊嘉, which is **not** the dividend-fee outlier earlier drafts assumed. So **SC and ICBC-Wealth — the only banks with $0 custody — sit at ~HK$145, behind every broker**; the custody-charging banks climb from there. **BOCHK worst in both phases** (~HK$3,385 / ~HK$2,150 — HK$2,000 custody + HK$75 dividend min are structural). *(See the registration-fee caveat above — a HK$1.5/lot 过户费 can add ~HK$240/yr at HK$1M scale.)*
- **Promos:** Most brokers run standing **$0-commission** offers, so the platform fee is the true cost (尊嘉 HK$1 ≪ the HK$15 crowd). **BOCHK's Monthly-Investment-Plan $0-commission promo fits this plan exactly** → Year-1 ~HK$2,185, but its HK$2,000 custody still leaves it last.
...
![首年总费用](charts/scenarioH_year1.png)
...
![第二年起年费](charts/scenarioH_year2.png)
...
![首年总费用](charts/scenarioI_year1.png)
...
![第6年起持有费用](charts/scenarioI_year6.png)
...
### 场景 J —— 13 家机构（7 银行 + 6 券商）：HK$100 万买 02800，100 个月月供（HK$1 万 × 100）

**每月 HK$10,000、单只 ETF —— 02800**（盈富基金，追踪恒生指数，**半年派**，股息率约 2.9%），连买 **100 个月** → HK$10,000 × 100 = **正好 HK$100 万**。ETF → 免印花税。本场景采用**不同的、以券商为主的阵容** —— 下列 **7 家银行 + 6 家券商**（非场景 G–I 的「11 银行 + 富途」组合）。银行费率沿用场景 G 费率表；券商费率为 2026 年 6 月核实（见[数据来源](#sources--数据来源)）。

> **本场景是场景 I 的极端版。** 场景 I 每笔 HK$16,700 已让佣金**最低收费**咬住；本场景每笔仅 **HK$10,000、且共 100 笔**，于是**每单固定成本（平台费 / 佣金最低收费）几乎就是全部账单** —— **零费券商压倒性胜出**。HK$100 的银行最低收费摊在 HK$10,000 上 = **实际 1.0%**；尊嘉 HK$1 平台费 = **0.01%**。100 倍差距，付 100 次。

> **HK$10,000 不足 02800 一手**（500 股 × 约 HK$25 ≈ HK$12,500）。须经**月供股票计划**（凑碎股/零股）或碎股市场执行 —— 这也意味着**月供 $0 佣金推广直接适用**（中银、汇丰，以及各券商常设优惠）。

**券商费率（港股、网上、2026 年 6 月 —— 全部 $0 托管、ETF 免印花税）：**

| 券商 | 佣金 | 平台费/单 | 代收股息费 |
|---|---|---|---|
| **尊嘉 Snowball** | **$0**（终身） | **HK$1** | **0.2%，最低 HK$30** + 登记过户费 HK$1.5/手，最低 HK$31.9 |
| 盈立 uSMART | $0（免佣计划） | HK$12 | ~0.2%，最低 HK$30 |
| 长桥 Longbridge | $0（终身） | HK$15 *(可低至 HK$3)* | ~0.2%，最低 HK$30 |
| 富途 Futu | $0 终身 *(促销)* · 基准 0.03%/最低 HK$3 | HK$15 | 0.2%，最低 HK$30 |
| 华盛 Valuable | 0.03%，最低 HK$3 | HK$15 | ~0.2%，最低 HK$30 |
| 老虎 Tiger | 0.029% *(含交收)* | HK$15 *(固定计划；阶梯 ≤5单/月为 HK$30)* | 0.2%，最低 HK$30 |

*（券商多有常设 $0 佣金推广，故平台费才是真实每单成本；托管各家均 $0。下单前请核实当下促销。）*

**每笔 HK$10,000 的成本**（*加粗 = 高最低收费咬住 → 实际费率远高于标称*）：

| 机构 | 费率算出 | 最低 / 平台 | 每笔收取 | 实际 |
|---|---|---|---|---|
| **尊嘉 Snowball** | $0 | 平台 HK$1 | **HK$1** | 0.01% |
| 盈立 uSMART | $0 | 平台 HK$12 | HK$12 | 0.12% |
| 长桥 Longbridge | $0 | 平台 HK$15 | HK$15 | 0.15% |
| 富途 Futu / 华盛 Valuable | HK$3（0.03%） | 最低 HK$3 + 平台 HK$15 | HK$18 | 0.18% |
| 老虎 Tiger | HK$3（0.029%） | 平台 HK$15 | HK$18 | 0.18% |
| 永隆 | HK$18（0.18%） | 最低 HK$4.88 | HK$18 *(按费率)* | 0.18% |
| 星展 | HK$20（0.20%） | 无 | HK$20 *(按费率)* | 0.20% |
| 渣打 | HK$20（0.20%） | 最低 HK$50 | **HK$50** | 0.50% |
| 工银 | HK$14（0.138%） | 最低 HK$88 | **HK$88** | 0.88% |
| 汇丰 / 中信 / 中银 | HK$25（0.25%） | 最低 HK$100 | **HK$100** | 1.00% |

**首年总费用**（首 12 笔买入 + 托管 + 2 次股息 + 约 HK$35 政府/交易所征费）：

![首年总费用](charts/scenarioJ_year1.png)

| # | 机构 | 佣金 ×12 | 首年托管 | 股息（2×） | **首年** |
|---|---|---|---|---|---|
| 1 | **尊嘉 Snowball** | HK$12 *(HK$1/单)* | $0 | HK$60 | **~HK$110** |
| 2 | **盈立 uSMART** | HK$144 *(HK$12/单)* | $0 | HK$60 | **~HK$240** |
| 3 | 长桥 Longbridge | HK$180 *(HK$15/单)* | $0 | HK$60 | **~HK$275** |
| 4 | 富途 Futu / 华盛 Valuable / 老虎 Tiger | HK$216 *(HK$18/单)* | $0 | HK$60 | **~HK$310** |
| 7 | 永隆 | HK$216 *(0.18%，无最低咬住)* | HK$120 | HK$60 | **~HK$430** |
| 8 | 星展 | HK$240 *(0.20%，无最低)* | HK$200 | HK$60 | **~HK$535** |
| 9 | 渣打 | HK$600 *(最低 HK$50)* | $0 | HK$60 | **~HK$695** |
| 10 | 工银 | HK$1,056 *(最低 HK$88)* | ~HK$200 | HK$40 | **~HK$1,330** |
| 11 | 中信国际 | HK$1,200 *(最低 HK$100)* | HK$200 | HK$60 | **~HK$1,495** |
| 12 | 汇丰 | HK$1,200 *(最低 HK$100)* | HK$300 | HK$60 | **~HK$1,595** |
| 13 | 中银香港 | HK$1,200 *(最低 HK$100)* | HK$2,000 | HK$150 | **~HK$3,385** |

**第 9 年起持有**（满仓 HK$100 万、**停止买入** —— 仅托管 + 收股息）。02800 **半年派 2 次大额股息**（每次约 HK$1.45 万 → 0.5% ≈ HK$72/次）超过所有最低收费，故**银行**股息费约 HK$145/年；券商更低/豁免的股息费 + **$0 托管**让它们落在地板：

![第9年起持有费用](charts/scenarioJ_steady.png)

| # | 机构 | 第9年起/年 |
|---|---|---|
| 1 | **6 家券商全部** —— 尊嘉 / 盈立 / 长桥 / 富途 / 华盛 / 老虎 | ~HK$60 *(托管 $0；股息 0.2% 最低 HK$30 × 2 次)* |
| 7 | 渣打 / 工银理财金 | ~HK$145 *(托管 $0；股息 0.5% ≈ HK$145)* |
| 9 | 永隆 | ~HK$265 |
| 10 | 中信国际 | ~HK$345 |
| 11 | 星展 | ~HK$395 |
| 12 | 汇丰 | ~HK$445 |
...
> **登记过户费提醒（依赖持有成本排名前请核实）。** 尊嘉 Snowball 另收 **登记过户费 HK$1.5/手，最低 HK$31.9，*每次派息*收取**（尊嘉客服 2026 年 6 月确认）。满仓 HK$100 万（02800 约 80 手）时为每次约 HK$120（约 HK$240/年），叠加在 0.2% 服务费之上 —— 会把其稳态推高至 **~HK$300**。其他券商与银行或有类似的转嫁费；上表**仅计 0.2%/最低 HK$30 的代收股息服务费**，故大额持仓请核实各家的登记过户/过户费。

**结论：**
- **首年 → 尊嘉 Snowball（~HK$110），且每家券商都胜过每家银行。** 6 家券商落在 **HK$110–310**；7 家银行落在 **HK$430–3,385**。交易这么小，每单**固定成本**就是全部：尊嘉 HK$1 平台费 → 全年佣金 HK$12，而 HK$100 最低收费的银行全年 HK$1,200。
- **银行里永隆、星展胜出**（~HK$430 / ~HK$535）—— 只有这两家佣金是纯费率（0.18% / 0.20%，无高最低收费）。**HK$100 最低收费的银行最差**（汇丰 / 中信 / 中银 ~HK$1,495–3,385）：HK$10,000 收 HK$100 = **实际 1%**，约为永隆真实 0.18% 的 5 倍。
- **工银又是中游**（~HK$1,330）：它 HK$88 的最低收费 —— 正是大额场景 H 取胜的武器 —— 在 HK$10,000 小额上成了累赘，另加 ~HK$200 托管（建仓期未达理财金）。
- **真正的数字是 100 个月建仓，而非首年。** 佣金每月重复，连付 **8⅓ 年**。**100 笔累计佣金：尊嘉 HK$100 · 盈立 HK$1,200 · 长桥 HK$1,500 · 富途/华盛/老虎/永隆 HK$1,800 · 星展 HK$2,000 · 渣打 HK$5,000 · 工银 HK$8,800 · 汇丰/中信/中银 HK$10,000。** 选尊嘉而非 HK$100 最低收费银行，整个建仓期省 **~HK$9,900** —— 买的是*同一只* ETF。
- **第 9 年起 → 6 家券商平手落在地板（~HK$60），甚至领先 $0 托管的银行。** 每家券商都是 **$0 托管** + 相同的代收股息服务费（0.2% 最低 HK$30 → ~HK$60/年）—— 含尊嘉，它**并非**早前草稿误以为的零股息费异类。故**渣打、工银理财金这两家唯一 $0 托管的银行落在 ~HK$145，仍落后于每一家券商**；收托管费的银行再往上排。**中银香港两阶段都最差**（~HK$3,385 / ~HK$2,150 —— HK$2,000 托管 + HK$75 股息最低是结构性的）。*（见上方登记过户费提醒 —— HK$1.5/手 过户费在 HK$100 万规模下可再加约 HK$240/年。）*
- **促销**：多数券商常设 **$0 佣金**推广，故平台费才是真实成本（尊嘉 HK$1 ≪ HK$15 一档）。**中银月供计划 $0 佣金推广恰好契合本计划** → 首年 ~HK$2,185，但其 HK$2,000 托管仍让它垫底。
...
- **Brokers (Scenario J), online fee schedules verified June 2026:** 富途 Futu ([commissions](https://www.futuhk.com/en/commissionnew) — $0-commission-forever promo + HK$15/order platform) · 盈立 uSMART ([charges](https://www.usmart.hk/zh-cn/charges) — 免佣 plan HK$0 commission + HK$12 platform) · 老虎 Tiger ([HK stocks](https://www.itigerup.com/en/help/detail/68697332) — 0.029% commission + HK$15 *fixed-plan* platform (tiered plan = HK$30 at ≤5 orders/mo); cash-dividend fee 0.2%, min HK$30) · 华盛 Valuable Capital ([fee standards](https://www.vbkr.com/help/topic2-trading-fee-standards) — 0.03%/min HK$3 + HK$15 platform) · 长桥 Longbridge ([rates](https://longbridge.com/hk/zh-CN/rate) — lifetime $0 commission + HK$15/order platform, tiered to HK$3) · 尊嘉 Snowball (lifetime $0 commission + HK$1/order platform; dividend 0.2%/min HK$30 **+ 登记过户费 HK$1.5/lot, min HK$31.9** — per 尊嘉 customer service, June 2026). All brokers: **$0 custody**, no stamp duty on ETF; **dividend service fee ~0.2%/min HK$30** (verified Futu/Tiger/尊嘉; assumed for the rest); standing $0-commission promos common — verify before acting.
