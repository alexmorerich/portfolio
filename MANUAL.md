...
**The one-sentence answer most people need:** for **small, frequent ETF buys**, a **zero-fee broker** (Snowball/尊嘉 cheapest) beats every bank; for a **long-term hold after you stop trading**, anything with **$0 custody** wins (all 6 brokers, plus SC and ICBC-Wealth among banks); the banks' fat **commission minimums** and **custody fees** are what make them expensive.
...
| 4 | **Dividend collection** 代收股息费 | **each dividend payout** | banks 0.5%, **min HK$30** (BOCHK HK$75, ICBC HK$20); brokers 0.2%/min HK$30 or waived | many small dividends (monthly-pay ETFs) |
...
|---|---|---|
| **Snowball 尊嘉** | **$0 commission + HK$1/order** platform, "no other hidden fees" — cheapest for tiny/frequent trades | smaller franchise; verify deposit/withdrawal path |
...
**多数人需要的一句话答案：** **小额、高频买入** → **零费券商**（尊嘉最省）胜过所有银行；**停止交易后的长期持有** → 任何 **$0 托管**的（6 家券商，加银行里的渣打、工银理财金）都赢；银行贵就贵在**高佣金最低收费**与**托管费**。
...
| 4 | **代收股息费** | **每次派息** | 银行 0.5%，**最低 HK$30**（中银 HK$75、工银 HK$20）；券商 0.2%/最低 HK$30 或豁免 | 多次小额派息（月派 ETF） |
...
| 券商 | 优势 | 陷阱 / 提醒 |
|---|---|---|
| **尊嘉 Snowball** | **$0 佣金 + HK$1/单**平台费、「无其他隐藏费用」—— 小额/高频最省 | 体量较小；核实出入金路径 |
